...
celeba.epochs_per_eval = 1
celeba.epochs_per_eval_save = 1
celeba.num_images_visualize = 4
celeba.num_variables_visualize = 3
celeba.num_temperatures_visualize = 1
celeba.dec_blocks = "1x1,4m1,4x1,8m4,8x1,16m8,16x1,32m8,32x1,64m8,64x1"
celeba.enc_blocks = "64x1,64d2,32x1,32d2,16x1,16d2,8x1,8d2,4x1,4d4,1x4"
celeba.no_bias_above = 64
celeba.grad_clip = 130.
celeba.skip_threshold = 180.
HPARAMS_REGISTRY['celeba'] = celeba
...
def parse_args_and_update_hparams(H, parser, s=None):
    ...
    #print(args)
    # with open('args_hparams.json', 'w') as fp:
    #    json.dump(vars(args), fp, indent=4)
    #    print('args_hparams.json saved!')
    ...
    # with open('H_dict.json', 'w') as fp:
    #    json.dump(vars(H), fp, indent=4)
    #    print('H_dict.json saved!')
